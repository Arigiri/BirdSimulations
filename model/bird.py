...
class Bird:
    ...
    def separation(self, birds, separation_radius):
        """
        Tránh va chạm với các chim lân cận.
        Trả về vector lực tách biệt.
        """
        steering = Vector2D()
        count = 0
    ...
    def alignment(self, birds, alignment_radius):
        """
        Điều chỉnh bay theo hướng chung của đàn.
        Trả về vector lực căn chỉnh.
        """
        steering = Vector2D()
        count = 0
    ...
    def cohesion(self, birds, cohesion_radius):
        """
        Di chuyển về phía trung tâm đàn.
        Trả về vector lực gắn kết.
        """
        steering = Vector2D()
        count = 0
    ...
    def seek_food(self, food_positions, ripeness, food_radius=50.0):
        """
        Di chuyển đến nơi có nhiều đồ ăn.
        Trả về vector lực tìm kiếm thức ăn.
        """
        ...
        if nearest_food is not None:
            desired = nearest_food - self.position
